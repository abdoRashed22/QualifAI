...
class AdminRepositoryImpl implements AdminRepository {
  ...
  Either<Failure, T> _err<T>(Object e) =>
      e is Failure ? Left(e) : Left(const UnknownFailure());

  @override
  Future<Either<Failure, List<dynamic>>> getEmployees() async {
    try {
      return _wrap(await _r.getEmployees());
    } catch (e) {
      return _err(e);
    }
  }
  ...
  @override
  Future<Either<Failure, void>> createEmployee(Map<String, dynamic> d) async {
    try {
      await _r.createEmployee(d);
  ...
  @override
  Future<Either<Failure, void>> createCollege(Map<String, dynamic> data) async {
    try {
      await _r.createCollege(data);
      return const Right(null);
    } catch (e) {
      return _err(e);
    }
  ...
  Future<Either<Failure, List<dynamic>>> getPlans() async {
    try {
      return _wrap(await _r.getPlans());
    } catch (e) {
      return _err(e);
    }
  }
  ...
  @override
  Future<Either<Failure, List<dynamic>>> getActivityLog() async {
    try {
      return _wrap(await _r.getActivityLog());
    } catch (e) {
      return _err(e);
    }
  }
