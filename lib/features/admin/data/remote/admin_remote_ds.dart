...
class AdminRemoteDs {
  ...
  Future<void> createEmployee(Map<String, dynamic> data) async {
    try {
      await _dio.post(ApiEndpoints.employees, data: data);
    } on DioException catch (e) {
      throw dioToFailure(e);
    }
  }
  ...
  Future<void> updateEmployee(int id, Map<String, dynamic> data) async {
    try {
      await _dio.put(ApiEndpoints.employeeById(id), data: data);
    } on DioException catch (e) {
      throw dioToFailure(e);
    }
  }
  ...
  Future<void> deleteCollege(int id) async {
    try {
      await _dio.delete(ApiEndpoints.collegeById(id));
    } on DioException catch (e) {
      throw dioToFailure(e);
    }
  }
  ...
  Future<List<dynamic>> getActivityLog() async {
    try {
      final r = await _dio.get(ApiEndpoints.activityLog);
      return r.data is List ? r.data : [];
    } on DioException catch (e) {
      throw dioToFailure(e);
    }
