...
import '../../../../core/cache/hive_cache.dart'; // ✅ مهم
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final HiveCache cache = sl<HiveCache>(); // ✅ FIX هنا
        ...
        body: BlocConsumer<AuthCubit, AuthState>(
          ...
          listener: (ctx, state) {
            ...
            if (state is AuthSuccess && !_navigated) {
              ...
              // ✅ FIX: role-based navigation — متطابق مع _mapRole الجديد
              ...
              if (role == 'admin') {
                ...
                // manager و employee و أي role تاني كلهم يروحوا dashboard
