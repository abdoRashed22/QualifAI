                  ...
                  child: SafeArea(
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Container(
                        ...
                        child: Center(child: Text('ðŸ¤–', style: TextStyle(fontSize: 44.sp))),
                      ),
                      SizedBox(height: 16.h),
                      Text('Welcome to QualifAI', style: GoogleFonts.cairo(fontSize: 22.sp, fontWeight: FontWeight.w700, color: Colors.white)),
                      SizedBox(height: 6.h),
                      Text('Ø³Ø¬Ù‘Ù„ Ø¯Ø®ÙˆÙ„Ùƒ Ù„Ù„Ù…ØªØ§Ø¨Ø¹Ø©', style: GoogleFonts.cairo(fontSize: 14.sp, color: Colors.white60)),
                    ]),
                  ),
                ),
                // White card
                      ...
                      child: Form(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                          ...
                          GestureDetector(
                            ...
                            child: Text('Ù†Ø³ÙŠØª ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±ØŸ', style: GoogleFonts.cairo(fontSize: 13.sp, color: AppColors.blue, fontWeight: FontWeight.w600)),
                          ),
                          SizedBox(height: 32.h),
                          AppButton(label: 'ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„', isLoading: state is AuthLoading, onPressed: () => _onLogin(cubit)),
                          SizedBox(height: 16.h),
                          Center(child: Text('v1.0.0  â€¢  QualifAI', style: GoogleFonts.cairo(fontSize: 11.sp, color: Theme.of(context).disabledColor))),
                        ]),
                      ),
                    ),
                  ),
