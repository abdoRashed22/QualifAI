...
class _StandardsListView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final title = accreditationType == 1 ? 'Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ø£ÙƒØ§Ø¯ÙŠÙ…ÙŠ' : 'Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ø¨Ø±Ø§Ù…Ø¬ÙŠ';
        ...
        builder: (ctx, state) {
          ...
          if (state is SectionsLoaded) {
            if (state.sections.isEmpty) {
              return const Center(child: Text('Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ø¹Ø§ÙŠÙŠØ±'));
            }
