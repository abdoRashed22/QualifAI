...
class _StandardDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Ø§Ù„Ù…Ø¹ÙŠØ§Ø±')),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('Ø¯Ø±Ø¬Ø© Ø§Ù„Ø§ÙƒØªÙ…Ø§Ù„', style: TextStyle(fontFamily: 'Cairo', fontSize: 13.sp, color: Colors.white60)),
                        ],
                      ),
                      SizedBox(height: 8.h),
                      ClipRRect(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        hasFile ? 'Ù…Ø±ÙÙˆØ¹ âœ“' : 'Ù„Ù… ÙŠÙØ±ÙØ¹ Ø¨Ø¹Ø¯',
                                        style: TextStyle(
                                          fontFamily: 'Cairo',
                                          fontSize: 11.sp,
    ...
    showDialog(
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setState) => AlertDialog(
          ...
          title: const Text('ØªØ­Ø¯ÙŠØ¯ Ø§Ù„Ù…ÙˆØ¹Ø¯ Ø§Ù„Ù†Ù‡Ø§Ø¦ÙŠ', textAlign: TextAlign.right),
          content: Column(
            ...
            children: [
              ...
              const Text('Ø§Ù„ØªØ°ÙƒÙŠØ±Ø§Øª', style: TextStyle(fontFamily: 'Cairo', fontWeight: FontWeight.w600)),
              CheckboxListTile(
                value: oneWeek, onChanged: (v) => setState(() => oneWeek = v!),
                title: const Text('Ù‚Ø¨Ù„ Ø£Ø³Ø¨ÙˆØ¹', style: TextStyle(fontFamily: 'Cairo', fontSize: 13)),
                controlAffinity: ListTileControlAffinity.leading,
                contentPadding: EdgeInsets.zero,
              ),
              CheckboxListTile(
                value: oneDay, onChanged: (v) => setState(() => oneDay = v!),
                title: const Text('Ù‚Ø¨Ù„ ÙŠÙˆÙ…', style: TextStyle(fontFamily: 'Cairo', fontSize: 13)),
                controlAffinity: ListTileControlAffinity.leading,
                contentPadding: EdgeInsets.zero,
              ),
              CheckboxListTile(
                value: onDue, onChanged: (v) => setState(() => onDue = v!),
                title: const Text('ÙŠÙˆÙ… Ø§Ù„Ø§Ø³ØªØ­Ù‚Ø§Ù‚', style: TextStyle(fontFamily: 'Cairo', fontSize: 13)),
                controlAffinity: ListTileControlAffinity.leading,
                contentPadding: EdgeInsets.zero,
              ),
            ],
