...
import 'package:qualif_ai/features/dashboard/presentation/screens/dashboard_screen.dart';
...
class ManagerScaffold extends StatelessWidget {
  const ManagerScaffold({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SideRailNavigation(
      ...
      mainItems: const [
        NavRailItem(
            icon: Icons.home, label: 'الرئيسية', screen: DashboardScreen()),
        NavRailItem(
        ...
        NavRailItem(
            ...
            label: 'الأسعار',
            screen: manager_pricing.PricingScreen()),
        NavRailItem(
