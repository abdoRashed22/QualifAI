...
import 'package:qualif_ai/features/roles/presentation/screens/roles_screen.dart';
...
import 'package:qualif_ai/features/admin/presentation/screens/subscription_status_screen.dart';
    ...
    return SideRailNavigation(
      ...
      mainItems: const [
        ...
        NavRailItem(
            ...
            label: 'حالة الاشتراك',
            screen: SubscriptionStatusScreen()),
        NavRailItem(
