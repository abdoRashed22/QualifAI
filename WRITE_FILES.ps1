# QualifAI — Write All Source Files
# IMPORTANT: Run CREATE_FOLDERS.ps1 FIRST!
# Run from: E:\Projects\qualif_ai
#   Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass
#   .\WRITE_FILES.ps1

Write-Host 'Writing QualifAI source files...' -ForegroundColor Cyan
...
Write-Host ''
Write-Host 'Done! 87 files written.' -ForegroundColor Green
Write-Host ''
...
git add -A
git commit -m "fix: UTF-8 Arabic encoding + google_fonts Cairo + clean project"
